        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="text-center mb-5">
                    ...
                    <h1 class="mt-3 font-weight-bold">Thank You for Your Order!</h1>
                ...
                @if($order->bill_firstname != $order->firstname || $order->bill_address != $order->address)
                <div class="order-details">
                ...
                <div class="text-center mt-5">
                    <a href="{{ route('home') }}" class="genric-btn primary circle arrow">Continue Shopping</a>
                </div>
            </div>
        </div>
    </div>
