...
@section("content")
  <form class="col-lg-6 col-md-8 col-10 mx-auto" action="{{ route('users.register.submit') }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="text-center">
        <a href="{{route('users.login')}}" class="nav-link">Already have an account? Login here.</a>
    </div>
