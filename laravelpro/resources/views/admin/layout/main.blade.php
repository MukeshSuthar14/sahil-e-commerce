...
<html lang="en">
  <head>
    ...
    {{-- me added --}}
    <link href="{{ asset('assets/js/lightbox2-2.11.5/dist/css/lightbox.min.css') }}" rel="stylesheet" />
  ...
  <body class="vertical  light  ">
    ...
    {{-- me added --}}
    <script src="{{ asset('assets/js/lightbox2-2.11.5/dist/js/lightbox.min.js') }}"></script>
